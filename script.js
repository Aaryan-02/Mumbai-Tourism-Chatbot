const API_KEY = 'AIzaSyDF3A_ioIkVi8gPN8kkMRtpQl9laMpUwto'; 
...
async function generateResponse(prompt) {
            ...
            contents: [
                {
                    parts: [
                        {
                            text: `You are a Mumbai Tourism Bot. Respond to queries about Mumbai tourism such as attractions, transportation, food, and culture. User query: "${prompt}"`
                        }
                    ]
                }
            ]
    ...
    return responseContent || 'I am sorry, I couldn’t find an answer. Please try again!';
}
